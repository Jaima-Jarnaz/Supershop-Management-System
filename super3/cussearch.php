...
<header><div class="nav">
    ...
    <div class="container">
      ...
      <?php
        ...
        $sql="SELECT * 
          FROM tb_customer
          WHERE tb_customer.cid = '$_POST[cid]'";
		...
		<center>
            ...
            while ($accused=mysqli_fetch_assoc($result))
          {
                  ...
                  echo"<td>".$accused['cid']."</td>";
                  echo "</tr>";
                  echo "<tr>";
                  echo"<th>Customer Name: </th>";
                  echo"<td>".$accused['cname']."</td>";
                  echo "</tr>";
                  echo "<tr>";
                  echo"<th>Customer Contact: </th>";
                  echo"<td>".$accused['cc']."</td>";
                  echo "</tr>";
          }
          ?>
        </table>
