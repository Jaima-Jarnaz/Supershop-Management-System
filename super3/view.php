...
if ($result->num_rows > 0) {
	  echo"<br><br><br><br>";
      echo"<table style='width:600px; margin:auto; color:black; padding:5px;' border='5' bgcolor='white'>";
     ...
     while($row = $result->fetch_assoc()) {
		...
		<td><a href =product_print.php?pid=".$row["pid"].">Print</a></td>
		</tr>";
     }
     echo "</table>";
} else {
...
<a href="product_all_print.php" class="button">All Print</a>
